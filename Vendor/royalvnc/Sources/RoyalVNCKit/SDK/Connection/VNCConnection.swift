...
public final class VNCConnection: NSObjectOrAnyObject {
	...
	lazy var encodings: Encodings = {
		...
		let compressionLevelEncodingType = VNCPseudoEncodingType.compressionLevel2.rawValue
		let compressionLevelEncoding = VNCProtocol.CompressionLevelEncoding(encodingType: compressionLevelEncodingType)

		let jpegQualityLevelEncodingType = VNCPseudoEncodingType.jpegQualityLevel4.rawValue
...
//			VNCPseudoEncodingType.extendedClipboard.rawValue,
			...
			VNCPseudoEncodingType.compressionLevel2.rawValue
		])

		if usesTightEncoding {
            // TODO: Make configurable
			encs.append(VNCPseudoEncodingType.jpegQualityLevel4.rawValue)
		}
