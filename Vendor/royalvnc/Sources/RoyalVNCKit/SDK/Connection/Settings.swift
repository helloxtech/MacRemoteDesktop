...
public extension VNCConnection {
    ...
    final class Settings: NSObjectOrAnyObject {
		...
		public let authenticationPreference: AuthenticationPreference
		...
		public init(isDebugLoggingEnabled: Bool,
					...
					authenticationPreference: AuthenticationPreference = .automatic,
			...
			self.authenticationPreference = authenticationPreference
...
public extension VNCConnection.Settings {
	...
	enum AuthenticationPreference: UInt8 {
		case automatic
		case preferUsernamePassword
